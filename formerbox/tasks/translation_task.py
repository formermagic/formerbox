...
from formerbox.modules import TranslationDataModule as DataModule
from formerbox.modules import TranslationModule as Module
...
@TaskModule.register("translation")
class TranslationTask(TaskModule[ParamsType]):
    @dataclass
    ...
    def add_argparse_params(
        cls: Type["TranslationTask"], parser: DataclassArgumentParser
    ) -> None:
