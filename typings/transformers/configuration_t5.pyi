...
class T5Config(PretrainedConfig):
    ...
    """
    model_type = ...
    def __init__(self, vocab_size=..., n_positions=..., d_model=..., d_kv=..., d_ff=..., num_layers=..., num_decoder_layers=..., num_heads=..., relative_attention_num_buckets=..., dropout_rate=..., layer_norm_epsilon=..., initializer_factor=..., is_encoder_decoder=..., pad_token_id=..., eos_token_id=..., **kwargs) -> None:
        ...
