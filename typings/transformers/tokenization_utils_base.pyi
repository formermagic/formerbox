...
from .file_utils import add_end_docstrings, is_flax_available, is_tf_available, is_tokenizers_available, is_torch_available, torch_required
...
LARGE_INTEGER = int(100000000000000000000)
TextInput = str
...
class BatchEncoding(UserDict):
    ...
    """
    def __init__(self, data: Optional[Dict[str, Any]] = ..., encoding: Optional[Union[EncodingFast, Sequence[EncodingFast]]] = ..., tensor_type: Union[None, str, TensorType] = ..., prepend_batch_axis: bool = ...) -> None:
        ...
    ...
    def word_to_tokens(self, batch_or_word_index: int, word_index: Optional[int] = ...) -> TokenSpan:
        """
    ...
    def char_to_token(self, batch_or_char_index: int, char_index: Optional[int] = ...) -> int:
        """
    ...
    def word_to_chars(self, batch_or_word_index: int, word_index: Optional[int] = ...) -> CharSpan:
        """
    ...
    def char_to_word(self, batch_or_char_index: int, char_index: Optional[int] = ...) -> int:
        """
...
class PreTrainedTokenizerBase(SpecialTokensMixin):
    ...
    def save_pretrained(self, save_directory: str, legacy_format: bool = ..., filename_prefix: Optional[str] = ...) -> Tuple[str]:
        """
    ...
    def batch_decode(self, sequences: List[List[int]], skip_special_tokens: bool = ..., clean_up_tokenization_spaces: bool = ...) -> List[str]:
        """
    ...
    def decode(self, token_ids: List[int], skip_special_tokens: bool = ..., clean_up_tokenization_spaces: bool = ..., **kwargs) -> str:
        """
