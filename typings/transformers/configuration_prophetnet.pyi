...
class ProphetNetConfig(PretrainedConfig):
    ...
    """
    model_type = ...
    def __init__(self, activation_dropout=..., activation_function=..., vocab_size=..., hidden_size=..., encoder_ffn_dim=..., num_encoder_layers=..., num_encoder_attention_heads=..., decoder_ffn_dim=..., num_decoder_layers=..., num_decoder_attention_heads=..., attention_dropout=..., dropout=..., max_position_embeddings=..., init_std=..., is_encoder_decoder=..., add_cross_attention=..., pad_token_id=..., bos_token_id=..., eos_token_id=..., decoder_start_token_id=..., ngram=..., num_buckets=..., relative_max_distance=..., disable_ngram_loss=..., eps=..., **kwargs) -> None:
        ...
