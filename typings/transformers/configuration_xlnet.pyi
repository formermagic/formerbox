...
class XLNetConfig(PretrainedConfig):
    ...
    """
    model_type = ...
    def __init__(self, vocab_size=..., d_model=..., n_layer=..., n_head=..., d_inner=..., ff_activation=..., untie_r=..., attn_type=..., initializer_range=..., layer_norm_eps=..., dropout=..., mem_len=..., reuse_len=..., bi_data=..., clamp_len=..., same_length=..., summary_type=..., summary_use_proj=..., summary_activation=..., summary_last_dropout=..., start_n_top=..., end_n_top=..., pad_token_id=..., bos_token_id=..., eos_token_id=..., **kwargs) -> None:
