...
from .file_utils import ModelOutput, replace_return_docstrings
...
class PreTrainedModel(nn.Module, ModuleUtilsMixin, GenerationMixin):
    ...
    def resize_token_embeddings(self, new_num_tokens: Optional[int] = ...) -> torch.nn.Embedding:
        """
...
def prune_linear_layer(layer: torch.nn.Linear, index: torch.LongTensor, dim: int = ...) -> torch.nn.Linear:
    """
...
def prune_layer(layer: Union[torch.nn.Linear, Conv1D], index: torch.LongTensor, dim: Optional[int] = ...) -> Union[torch.nn.Linear, Conv1D]:
    """
