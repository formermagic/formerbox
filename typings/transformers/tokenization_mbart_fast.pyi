...
class MBartTokenizerFast(XLMRobertaTokenizerFast):
    ...
    def prepare_seq2seq_batch(self, src_texts: List[str], src_lang: str = ..., tgt_texts: Optional[List[str]] = ..., tgt_lang: str = ..., max_length: Optional[int] = ..., max_target_length: Optional[int] = ..., truncation: bool = ..., padding: str = ..., return_tensors: str = ..., **kwargs) -> BatchEncoding:
        ...
