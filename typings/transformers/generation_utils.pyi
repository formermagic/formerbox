...
class GenerationMixin:
    ...
    @torch.no_grad()
    def generate(self, input_ids: Optional[torch.LongTensor] = ..., max_length: Optional[int] = ..., min_length: Optional[int] = ..., do_sample: Optional[bool] = ..., early_stopping: Optional[bool] = ..., num_beams: Optional[int] = ..., temperature: Optional[float] = ..., top_k: Optional[int] = ..., top_p: Optional[float] = ..., repetition_penalty: Optional[float] = ..., bad_words_ids: Optional[Iterable[int]] = ..., bos_token_id: Optional[int] = ..., pad_token_id: Optional[int] = ..., eos_token_id: Optional[int] = ..., length_penalty: Optional[float] = ..., no_repeat_ngram_size: Optional[int] = ..., num_return_sequences: Optional[int] = ..., decoder_start_token_id: Optional[int] = ..., use_cache: Optional[bool] = ..., num_beam_groups: Optional[int] = ..., diversity_penalty: Optional[float] = ..., prefix_allowed_tokens_fn: Optional[Callable[[int, torch.Tensor], List[int]]] = ..., output_attentions: Optional[bool] = ..., output_hidden_states: Optional[bool] = ..., output_scores: Optional[bool] = ..., return_dict_in_generate: Optional[bool] = ..., **model_kwargs) -> Union[GreedySearchOutput, SampleOutput, BeamSearchOutput, BeamSampleOutput, torch.LongTensor]:
        r"""
    ...
    def greedy_search(self, input_ids: torch.LongTensor, logits_processor: Optional[LogitsProcessorList] = ..., max_length: Optional[int] = ..., pad_token_id: Optional[int] = ..., eos_token_id: Optional[int] = ..., output_attentions: Optional[bool] = ..., output_hidden_states: Optional[bool] = ..., output_scores: Optional[bool] = ..., return_dict_in_generate: Optional[bool] = ..., **model_kwargs) -> Union[GreedySearchOutput, torch.LongTensor]:
        r"""
    ...
    def sample(self, input_ids: torch.LongTensor, logits_processor: Optional[LogitsProcessorList] = ..., logits_warper: Optional[LogitsProcessorList] = ..., max_length: Optional[int] = ..., pad_token_id: Optional[int] = ..., eos_token_id: Optional[int] = ..., output_attentions: Optional[bool] = ..., output_hidden_states: Optional[bool] = ..., output_scores: Optional[bool] = ..., return_dict_in_generate: Optional[bool] = ..., **model_kwargs) -> Union[SampleOutput, torch.LongTensor]:
        r"""
    ...
    def beam_search(self, input_ids: torch.LongTensor, beam_scorer: BeamScorer, logits_processor: Optional[LogitsProcessorList] = ..., max_length: Optional[int] = ..., pad_token_id: Optional[int] = ..., eos_token_id: Optional[int] = ..., output_attentions: Optional[bool] = ..., output_hidden_states: Optional[bool] = ..., output_scores: Optional[bool] = ..., return_dict_in_generate: Optional[bool] = ..., **model_kwargs) -> Union[BeamSearchOutput, torch.LongTensor]:
        r"""
    ...
    def beam_sample(self, input_ids: torch.LongTensor, beam_scorer: BeamScorer, logits_processor: Optional[LogitsProcessorList] = ..., logits_warper: Optional[LogitsProcessorList] = ..., max_length: Optional[int] = ..., pad_token_id: Optional[int] = ..., eos_token_id: Optional[int] = ..., output_attentions: Optional[bool] = ..., output_hidden_states: Optional[bool] = ..., output_scores: Optional[bool] = ..., return_dict_in_generate: Optional[bool] = ..., **model_kwargs) -> Union[BeamSampleOutput, torch.LongTensor]:
        r"""
