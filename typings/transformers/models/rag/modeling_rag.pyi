...
class RagTokenForGeneration(RagPreTrainedModel):
    ...
    @torch.no_grad()
    def generate(self, input_ids: Optional[torch.LongTensor] = ..., attention_mask: Optional[torch.LongTensor] = ..., context_input_ids=..., context_attention_mask=..., doc_scores=..., max_length=..., min_length=..., early_stopping=..., use_cache=..., num_beams=..., num_beam_groups=..., diversity_penalty=..., bos_token_id=..., pad_token_id=..., eos_token_id=..., length_penalty=..., no_repeat_ngram_size=..., repetition_penalty=..., bad_words_ids=..., num_return_sequences=..., decoder_start_token_id=..., n_docs=..., prefix_allowed_tokens_fn: Callable[[int, torch.Tensor], List[int]] = ..., **model_kwargs):
        """
