...
class TFT5Attention(tf.keras.layers.Layer):
    ...
    def call(self, hidden_states, mask=..., key_value_states=..., position_bias=..., past_key_value=..., head_mask=..., query_length=..., use_cache=..., training=..., output_attentions=...):
        """
...
class TFT5LayerCrossAttention(tf.keras.layers.Layer):
    ...
    def call(self, hidden_states, key_value_states, attention_mask=..., position_bias=..., head_mask=..., past_key_value=..., query_length=..., use_cache=..., output_attentions=..., training=...):
        ...
...
class TFT5MainLayer(tf.keras.layers.Layer):
    ...
    def call(self, input_ids=..., attention_mask=..., encoder_hidden_states=..., encoder_attention_mask=..., inputs_embeds=..., head_mask=..., past_key_values=..., use_cache=..., output_attentions=..., output_hidden_states=..., return_dict=..., training=..., **kwargs) -> Tuple:
        ...
...
class TFT5Model(TFT5PreTrainedModel):
    ...
    def call(self, input_ids=..., attention_mask=..., decoder_input_ids=..., decoder_attention_mask=..., encoder_outputs=..., past_key_values=..., head_mask=..., inputs_embeds=..., decoder_inputs_embeds=..., use_cache=..., output_attentions=..., output_hidden_states=..., return_dict=..., training=..., **kwargs):
        r"""
        Returns:
...
class TFT5ForConditionalGeneration(TFT5PreTrainedModel, TFCausalLanguageModelingLoss):
    ...
    def call(self, input_ids=..., attention_mask=..., decoder_input_ids=..., decoder_attention_mask=..., encoder_outputs=..., past_key_values=..., head_mask=..., inputs_embeds=..., decoder_inputs_embeds=..., labels=..., use_cache=..., output_attentions=..., output_hidden_states=..., return_dict=..., training=..., **kwargs):
        r"""
