...
class TFMBartModel(TFMBartPreTrainedModel):
    ...
    @add_code_sample_docstrings(tokenizer_class=_TOKENIZER_FOR_DOC, checkpoint="facebook/mbart-large-cc25", output_type=TFSeq2SeqModelOutput, config_class=_CONFIG_FOR_DOC)
