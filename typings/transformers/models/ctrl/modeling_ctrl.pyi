...
class CTRLLMHeadModel(CTRLPreTrainedModel):
    ...
    def prepare_inputs_for_generation(self, input_ids, past=..., use_cache=..., **kwargs):
        ...
...
class CTRLForSequenceClassification(CTRLPreTrainedModel):
    ...
    @add_start_docstrings_to_model_forward(CTRL_INPUTS_DOCSTRING)
    @add_code_sample_docstrings(tokenizer_class=_TOKENIZER_FOR_DOC, checkpoint="ctrl", output_type=SequenceClassifierOutput, config_class=_CONFIG_FOR_DOC)
    def forward(self, input_ids=..., past_key_values=..., attention_mask=..., token_type_ids=..., position_ids=..., head_mask=..., inputs_embeds=..., labels=..., use_cache=..., output_attentions=..., output_hidden_states=..., return_dict=...):
        r"""
