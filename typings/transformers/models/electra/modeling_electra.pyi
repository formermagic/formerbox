...
class ElectraEmbeddings(nn.Module):
    ...
    def forward(self, input_ids=..., token_type_ids=..., position_ids=..., inputs_embeds=..., past_key_values_length=...):
        ...
...
class ElectraModel(ElectraPreTrainedModel):
    ...
    @add_code_sample_docstrings(tokenizer_class=_TOKENIZER_FOR_DOC, checkpoint="google/electra-small-discriminator", output_type=BaseModelOutputWithCrossAttentions, config_class=_CONFIG_FOR_DOC)
