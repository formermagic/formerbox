...
def load_graph_from_args(pipeline_name: str, framework: str, model: str, tokenizer: Optional[str] = ...) -> Pipeline:
    """
...
def convert(framework: str, model: str, output: Path, opset: int, tokenizer: Optional[str] = ..., use_external_format: bool = ..., pipeline_name: str = ...):
    """
