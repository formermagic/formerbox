...
class ModelInfo:
    ...
    """
    def __init__(self, modelId: Optional[str] = ..., author: Optional[str] = ..., downloads: Optional[int] = ..., tags: List[str] = ..., pipeline_tag: Optional[str] = ..., siblings: Optional[List[Dict]] = ..., **kwargs) -> None:
        ...
    


class HfApi:
    ALLOWED_S3_FILE_TYPES = ...
    ...
    def presign(self, token: str, filetype: str, filename: str, organization: Optional[str] = ...) -> PresignedUrl:
        """
    ...
    def presign_and_upload(self, token: str, filetype: str, filename: str, filepath: str, organization: Optional[str] = ...) -> str:
        """
        HuggingFace S3-based system, used for datasets and metrics.
    ...
    def list_objs(self, token: str, filetype: str, organization: Optional[str] = ...) -> List[S3Obj]:
        """
        HuggingFace S3-based system, used for datasets and metrics.
    ...
    def delete_obj(self, token: str, filetype: str, filename: str, organization: Optional[str] = ...):
        """
        HuggingFace S3-based system, used for datasets and metrics.
