...
class TFTrainer:
    ...
    """
    def __init__(self, model: TFPreTrainedModel, args: TFTrainingArguments, train_dataset: Optional[tf.data.Dataset] = ..., eval_dataset: Optional[tf.data.Dataset] = ..., compute_metrics: Optional[Callable[[EvalPrediction], Dict]] = ..., tb_writer: Optional[tf.summary.SummaryWriter] = ..., optimizers: Tuple[tf.keras.optimizers.Optimizer, tf.keras.optimizers.schedules.LearningRateSchedule] = ..., **kwargs) -> None:
        ...
